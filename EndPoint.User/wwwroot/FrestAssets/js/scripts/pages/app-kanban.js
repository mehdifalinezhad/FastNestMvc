...
$(document).ready(function () {
	...
	var kanban_board_data = [{
			...
			item: [{
					...
					attachment: 3,
					users: [
						"../../FrestAssets/images/portrait/small/avatar-s-11.jpg",
						"../../FrestAssets/images/portrait/small/avatar-s-12.jpg"
					]
				},
				{
					id: "12",
					title: "چیزی بنویسید",
					border: "info",
					image: "../../FrestAssets/images/banner/banner-21.jpg",
					dueDate: "10 اردیبهشت"
				},
				{
					id: "13",
					...
					attachment: 4,
					users: [
						"../../FrestAssets/images/portrait/small/avatar-s-1.jpg",
						"../../FrestAssets/images/portrait/small/avatar-s-18.jpg"
					]
				},
				{
					id: "14",
					...
					attachment: 2,
					users: [
						"../../FrestAssets/images/portrait/small/avatar-s-26.jpg",
						"../../FrestAssets/images/portrait/small/avatar-s-16.jpg"
					]
				},
				{
					id: "15",
		...
		},
		{
			...
			item: [{
				...
				},
				{
					...
					comment: 8,
					users: [
						"../../FrestAssets/images/portrait/small/avatar-s-24.jpg",
						"../../FrestAssets/images/portrait/small/avatar-s-14.jpg"
					]
				},
				{
					id: "23",
		...
		},
		{
			...
			item: [{
					...
					comment: 10,
					users: [
						"../../FrestAssets/images/portrait/small/avatar-s-20.jpg",
						"../../FrestAssets/images/portrait/small/avatar-s-22.jpg",
						"../../FrestAssets/images/portrait/small/avatar-s-13.jpg"
					]
				},
				{
					id: "32",
				...
				},
				{
					...
					users: [
						"../../FrestAssets/images/portrait/small/avatar-s-1.jpg",
						"../../FrestAssets/images/portrait/small/avatar-s-2.jpg"
					]
				}
			]
		}
