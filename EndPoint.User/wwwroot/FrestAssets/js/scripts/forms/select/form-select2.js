...
(function (window, document, $) {
    ...
    // فعال‌سازی Select2 برای تمام المان‌هایی که کلاس select2-size-lg دارند
    $('.select2-size-lg').select2({
        ...
        language: {
            ...
            inputTooShort: function (args) {
                ...
                return "لطفاً " + remainingChars + " کاراکتر دیگر وارد کنید.";
            },
            loadingMore: function () {
                return "در حال بارگذاری نتایج بیشتر...";
            },
            maximumSelected: function (args) {
                return "شما تنها می‌توانید " + args.maximum + " گزینه را انتخاب کنید.";
            },
            noResults: function () {
                return "هیچ نتیجه‌ای یافت نشد.";
            },
            searching: function () {
                return "در حال جست‌وجو...";
            },
            removeAllItems: function () {
                return "حذف همه موارد";
            }
        },
