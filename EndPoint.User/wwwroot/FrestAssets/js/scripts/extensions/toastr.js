...
{
	var divData = $("#toast-data");

	var toastType = divData.data("type");
	var toastMessage =divData.data("message");
	if (toastMessage) {
		if (toastType === "success") {
			toastr.success(toastMessage, 'پیام', { rtl: true, positionClass: 'toast-top-left' });
		} else if (toastType === "error") {
			toastr.error(toastMessage, 'پیام', { rtl: true, positionClass: 'toast-top-left' });
		} else if (toastType === "warning") {
			toastr.warning(toastMessage, 'پیام', { rtl: true, positionClass: 'toast-top-left' });
		} else if (toastType === "info") {
			toastr.info(toastMessage, 'پیام', { rtl: true, positionClass: 'toast-top-left' });
		}
	}
